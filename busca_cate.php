...
<table>
<h1 class="logo"> Funcion Buscar Categoria</h1><br>  
 ...
 if (isset($_POST["enviar"])){
  ...
  <?php
  try {
    $sql="SELECT * FROM categoria WHERE nombre_c =?";
    ...
    $contador = $resultado -> rowCount();
     if ($contador >= 1) {
      while ($consulta = $resultado->fetch(PDO:: FETCH_ASSOC)){
        ?>
        <tr>
          <td class="box2"><?php echo $consulta["nombre_c"];?> </td>
            <td class="box2"><?php echo $consulta["descripcion_c"];?> </td>
         </tr>
        <?php
      }
